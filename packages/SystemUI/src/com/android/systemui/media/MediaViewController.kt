...
class MediaViewController @Inject constructor(
    ...
    init {
        ...
        context.contentResolver.registerContentObserver(
            Settings.Secure.getUriFor("lockscreen_media_metadata"),
            false,
            settingsObserver,
            UserHandle.USER_ALL
        )
        context.contentResolver.registerContentObserver(
            Settings.System.getUriFor("ambient_media_art_enabled"),
            false,
            settingsObserver,
            UserHandle.USER_ALL
        )
        ...
        context.contentResolver.registerContentObserver(
            Settings.System.getUriFor("ls_media_art_blur_level"),
            false,
            settingsObserver,
            UserHandle.USER_ALL
        )
    ...
    private fun updateSettings() {
        featureEnabled = Settings.Secure.getIntForUser(
