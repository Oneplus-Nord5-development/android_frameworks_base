...
public class HideGmsUtils {
    private static final Set<String> gmsPackages =
        new HashSet<>(
            Arrays.asList(
    ...
    private static Set<String> getApps(ContentResolver cr) {
        ...
        String apps = Settings.Secure.getString(cr, Settings.Secure.HIDE_GMS);
